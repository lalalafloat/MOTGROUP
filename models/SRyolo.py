...
from SuperYOLO.utils.autoanchor import check_anchor_order
from SuperYOLO.utils.general import make_divisible, check_file, set_logging
from SuperYOLO.utils.torch_utils import time_synchronized, fuse_conv_and_bn, model_info, scale_img, initialize_weights, \
...
class Model(nn.Module):
    ...
    def forward(self, x, ir=torch.randn(1,3,512,512), input_mode='RGB', augment=False, profile=False):
